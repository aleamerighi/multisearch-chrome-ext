...
function setup() {
  ...
  // also target buttons for social networks and use p5 event changed() to trigger function
...
function searchQuery() {
  ...
  for (var i = 0; i < urlList.length; i++) {
    ...
    // interaction with Chrome API opens multiple tabs for selected link in the current window
    chrome.tabs.create({
      url: urlList[i]
    });
  }
